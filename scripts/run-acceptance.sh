...
# 1 - LAUNCH STACK
docker-rancher-tools rancher-compose -p ${STACK_NAME} -r acceptance-tests/target/rancher-compose.yml -f acceptance-tests/target/docker-compose.yml up cloudframe-security-vault cloudframe-security-vault-at -d
